...
void AtModem::ResetPointers ()
{
  ...
  const char AtModem::kReceiveRootNumberEnable[] = { "+ROOT: ENABLE\0" };
  const char *AtModem::pReceiveRootNumberEnable = &AtModem::kReceiveRootNumberEnable[ 0 ];

  const char AtModem::kReceiveRootNumberDisable[] = { "+ROOT: DESABLE\0" };
  const char *AtModem::pReceiveRootNumberDisable = &AtModem::kReceiveRootNumberDisable[ 0 ];

  // 0 - id, 1 - telefone, 2 - pessoa
  const char AtModem::kReceiveRootNumberAddPhoneBook[] = { "+ADD: {pt} {pt} {pt}\0" };
  const char *AtModem::pReceiveRootNumberAddPhoneBook = &AtModem::kReceiveRootNumberAddPhoneBook[ 0 ];

  //
  const char AtModem::kReceiveRootNumberDelPhoneBook[] = { "+DEL: {pt} {pt}\0" };
  const char *AtModem::pReceiveRootNumberDelPhoneBook = &AtModem::kReceiveRootNumberDelPhoneBook[ 0 ];

  // 0 - telefone
  // O texto "Root Number" deve ser idêntico ao texto contido em AtModem::kRootName
  const char AtModem::kSendSetRootPhoneBook[] = { "AT+CPBW=250,\"{pt}\",129,\"Root Number\"\r\n\0" };
  const char AtModem::kSendClearRootPhoneBook[] = { "AT+CPBW=250,\"000000000\",129,\"\"\r\n\0" };

  const char AtModem::kRootName[] = { "Root Number\0" };
  const char *AtModem::pRootName = &AtModem::kRootName[ 0 ];

  void AtModem::SetRootPhoneBook ()
  {
    AtModem::pDataTxToModem[ 0 ] = &AtModem::kSendSetRootPhoneBook[ 0 ];
    AtModem::pDataRxToModem[ 0 ] = '\0';
  ...
  void AtModem::ClearRootPhoneBook ()
  {
    AtModem::pDataTxToModem[ 0 ] = &AtModem::kSendClearRootPhoneBook[ 0 ];
    AtModem::pDataRxToModem[ 0 ] = '\0';
  ...
  void AtModem::SetPhoneBook ()
  {
    *AtModem::pDataTxToModemId = '\0';
...
*/
  ...
  const char AtModem::kSendSmsDeleteMessageId[] = { "AT+CMGD=1\r\n\0" };
